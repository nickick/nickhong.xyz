...
export const projects: Project[] = [
  {
    ...
    description: [
      ...
      "One fun wrinkle in this drop is that the NFT has a built-in toggle to flip between 2 image assets. I spun up a quick site to enable transactions to flip NFTs in a wallet, at <a href='https://gallery.driftershoots.com' target='_blank' class='underline'>gallery.driftershoots.com</a>.",
    ],
